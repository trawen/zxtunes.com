 ...
 * 
 * PHP-клиент, версия 0.7 от 06.07.2007
 *
    ...
    function load_links() {
        ...
        if (array_key_exists($this->_request_uri, $this->_links) && is_array($this->_links[$this->_request_uri])) {
            ...
            if (isset($this->_links['__sape_new_url__']) && strlen($this->_links['__sape_new_url__'])) {
                ...
                // Показываем чек-код только нашим роботам
                if (in_array($_SERVER['REMOTE_ADDR'], $this->_links['__sape_ips__']) || $this->_force_show_code) {

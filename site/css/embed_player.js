...
function InsertPlayer(tr, au) {
  ...
  swfobject.embedSWF("/css/player77.swf", "player", "275", "13", "10.0", "expressInstall.swf", params, {bgcolor:params.background} );
...
function getParams(par) {
		...
		// $('#autoplay').val("/author.php?id="+author_id+"&play="+last_track);	
...
function FullUpdate(tr) {
	...
	var soc = "/author.php?id="+aid+"%26play="+tr;

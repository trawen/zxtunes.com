...
function InsertPlayer(tr, au) {
  ...
  swfobject.embedSWF("css/player28.swf", "player", "345", "13", "10.0", "expressInstall.swf", params, {bgcolor:params.background} );
...
function Loop(lp) {
	...
	if (lp == 1) {loop = "true";} else {loop = "false";}
...
function ChangeVolume(vol) {
	...
	volume = vol;
	setCookie("volume", vol, "Mon, 01-Jan-2011 00:00:00 GMT", "/");

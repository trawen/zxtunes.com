...
<div class="zx-search-list">
{section name=n loop=$search_authors}
<div class="zx-search-list__row">
<div class="zx-search-list__num">{$search_authors[n].nm}.</div>
<div>
...
<div class="zx-search-list__row">
<div class="zx-search-list__num">{$search_groups[n].nm}.</div>
<div>
...
<div class="zx-track-list__row" id="s{$search_tunes[n].id}">
<div>
...
<div><a class="m" href="{$search_tunes[n].author_id|aurl}">{$search_tunes[n].nickname}</a></div>
<div id="f{$search_tunes[n].id}"><a class="m" href="/downloads.php?id={$search_tunes[n].id}" title="{if $language eq 'rus'}Скачать {else}Download {/if}{$search_tunes[n].filename|strip_tags}">{$search_tunes[n].filename}</a></div>
<div id="t{$search_tunes[n].id}" class="zx-track-list__cell--title" style="color: #888">{if $search_tunes[n].name}{$search_tunes[n].name}{else}&nbsp;{/if}</div>
...
<div id="c{$search_tunes[n].id}" class="comment_off zx-track-list__line"></div>
<div id="pl{$search_tunes[n].id}" class="plln zx-track-list__line"></div>
{/section}
</div>
</section>
{/if}
...
<div class="zx-search-list__row">
<div class="zx-search-list__num">{$search_software[n].nm}.</div>
<div>
...
<div class="zx-search-list__row">
<div class="zx-search-list__num">{$search_remixes[n].nm}.</div>
<div>

...
<div align="center" style="font: bold 13px Verdana; color: white; background-color: #596680">ZXTunes Player v1.0</div>
...
track1:"fym2/{$author_id}/{$playlist[0].id}.fym",
volume:"0.8",
autostart:"false",
mixer:"YM ABC",
movie:"player5.swf",
...
{/literal}
		swfobject.embedSWF("css/player5.swf", "player", "385", "24", "10.0", "expressInstall.swf", {literal}params, {bgcolor:params.background} );
	</script>
{/literal}
...
<tr><td colspan="9"><div id="lol">lol</div></td></tr>
...
<tr><td></td><td colspan="8" style="height: 1px; background-color: #F0F0F0"></td></tr>
{/if}
...
<td id="t{$playlist[n].id}" style="color: #888">{if $playlist[n].name}{$playlist[n].name}{else}&nbsp;{/if}</td>
...
<tr><td></td><td colspan="7" style="height: 1px; background-color: #F0F0F0"></td></tr>
{/section}
